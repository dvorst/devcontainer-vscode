...
ccurl() {
	...
	#   proto https: allow HTTPS only, no HTTP
	#   tlsv1.2: allow TLS >=1.2 only, no old security protocols
...
install_opentofu() {
	...
	ccurl -o /tmp/install-opentofu.sh https://get.opentofu.org/install-opentofu.sh
